package com.kstopa.projectmanagement.config
...
case class AuthenticationConfig(secret: String)
case class Config(server: ServerConfig, database: DatabaseConfig, authentication: AuthenticationConfig)
